...
class InMemoryGraphListener(GraphListener):
    ...
    def add_listeners(self):
        self.graph.set_metadata.event.add_listener(self.set_graph_metadata)
        self.graph.rename.event.add_listener(self.rename_graph)
        self.graph.remove_component.event.add_listener(self.remove_component)
        self.graph.rename_component.event.add_listener(self.rename_component)
        self.graph.put_component.event.add_listener(self.put_component)
        self.graph.export.event.add_listener(self.export)
        self.graph.remove_inport.event.add_listener(self.remove_inport)
        self.graph.remove_outport.event.add_listener(self.remove_outport)
        self.graph.set_inport_metadata.event.add_listener(self.set_inport_metadata)
        self.graph.set_outport_metadata.event.add_listener(self.set_outport_metadata)
        self.graph.rename_inport.event.add_listener(self.rename_inport)
        self.graph.rename_outport.event.add_listener(self.rename_outport)
        self.graph.connect.event.add_listener(self.connect)
        self.graph.disconnect.event.add_listener(self.disconnect)
        self.graph.set_node_metadata.event.add_listener(self.set_node_metadata)
        self.graph.set_edge_metadata.event.add_listener(self.set_edge_metadata)
        self.graph.initialize.event.add_listener(self.initialize)
        self.graph.uninitialize.event.add_listener(self.uninitialize)
        self.graph.add_group.event.add_listener(self.add_group)
        self.graph.remove_group.event.add_listener(self.remove_group)
        self.graph.rename_group.event.add_listener(self.rename_group)
        self.graph.change_group.event.add_listener(self.change_group)
